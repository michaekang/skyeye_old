...
#endif
int
nandflash_s3c6410_read_word (struct device_desc *dev, uint32 addr, uint32 * data)
{
	struct nandflash_device *nandflash_dev = (struct nandflash_device *) dev->dev;
	struct nandflash_s3c6410_io *io = (struct nandflash_s3c2410_io *) dev->data;
...
int
nandflash_s3c6410_write_word (struct device_desc *dev, uint32 addr, uint32 data)
{
	struct nandflash_device *nandflash_dev = (struct nandflash_device *) dev->dev;
	struct nandflash_s3c6410_io *io = (struct nandflash_s3c2410_io *) dev->data;
	//struct nandflash_sb_status *nf = (struct nandflash_sb_status*)nandflash_dev->priv;
...
void
nandflash_s3c6410_init (struct device_module_set *mod_set)
{
	int i;
